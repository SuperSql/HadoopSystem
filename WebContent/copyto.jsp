...
<body>
 ...
 %>
	...
	<table align="center" id="tb4" border="1" cellpadding="0"
		cellspacing="0">
		<tr>
			<td width="600">文件名</td>
			<td>安全等级</td>
 ...
 %> <a
	...
	<table align="center">
		<tr>
			<td><input align="center" width="150px" type="button"
				width="150" name="createdirectory" value="移动"
				onclick="createdirectory()" style="align: center; width: 100px" /></td>
				<td width="100"></td>
				<td><input align="center" width="150px" type="button"
				width="150" name="createdirectory" value="取消"
				onclick="createdirectory()" style="align: center; width: 100px" /></td>
		</tr>
	</table>
